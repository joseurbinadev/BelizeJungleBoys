...
module.exports = {
  siteMetadata: {
    ...
    keywords: `Cave tubing Belize,Jaguar Paw, Jaguar Paw Belize, Jaguar Paw Tours, Zip Line, Jungle ATV,Jaguar Paw Cave and Jungle Expedition,cruise ship deals,Belize Curise Ship,cave tubing at jaguar paw, cave kayaking at jaguar paw`,
  ...
  plugins: [
   ...
   
    {
      ...
      options: {
        ...
        // theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `src/images/belize-jungle-boys-logo.avif`, // This path is relative to the root of the site.
      },
    },
  ],
}
